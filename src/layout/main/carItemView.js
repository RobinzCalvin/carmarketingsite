  ...
  return (
    <div className="container w-full flex flex-col items-center space-x-5  ">
        ...
        <div className="w-full h-96">
            <DemoCarousel carDataimagelist = {carData.image} />
        </div>
        <div className="w-full flex flex-row pt-2">
            <div className="w-1/2 flex flex-col">
                <h2 className="text-4xl text-bold float-left">{carData.type} </h2>
                <h6 className="float-left">{carData.vin}</h6>
            </div>
            <div className="w-1/2 flex flex-row justify-end pr-10">
                <h2 className="float-right text-[#3182CE]">FINAL BID: </h2>
                <h2  className="float-right text-[#3182CE]">{carData.price}</h2>
            </div>
        </div>
        <div className="w-full flex flex-row">
            <div className="w-1/2 flex flex-col">
                ...
                <div className="w-full flex justify-between p-2">
                    ...
                    <label className="text-lg pr-10">{carData.Auction}</label>
                </div>
                <div className="w-full flex justify-between p-2">
                    <h3 className="text-lg text-bold">Lot</h3>
                    <label className="text-lg pr-10">{carData.Lot}</label>
                </div>
                <div className="w-full flex justify-between p-2">
                    <h3 className="text-lg text-bold">Sale date</h3>
                    <label className="text-lg pr-10">{carData.Saledate}</label>
                </div>
                <div className="w-full flex justify-between p-2">
                    <h3 className="text-lg text-bold">Status</h3>
                    <label className="text-lg pr-10">{carData.Status}</label>
                </div>
                <div className="w-full flex justify-between p-2">
                    <h3 className="text-lg text-bold">Documents</h3>
                    <label className="text-lg pr-10">{carData.Documents}</label>
                </div>
            </div>
            <div className="w-1/2 flex flex-col">
            <div className="w-full flex flex-row space-x-5 p-2">
                ...
                <div className="w-full flex justify-between p-2">
                    <h3 className="text-lg text-bold">Make</h3>
                    <label className="text-lg pr-10">{carData.Make}</label>
                </div>
                <div className="w-full flex justify-between p-2">
                    <h3 className="text-lg text-bold">Model</h3>
                    <label className="text-lg pr-10">{carData.Model}</label>
                </div>
                <div className="w-full flex justify-between p-2">
                    <h3 className="text-lg text-bold">Production Year</h3>
                    <label className="text-lg pr-10">{carData.Productionyear}</label>
                </div>
                <div className="w-full flex justify-between p-2">
                    <h3 className="text-lg text-bold">Odometer</h3>
                    <label className="text-lg pr-10">{carData.Odometer}</label>
                </div>
                <div className="w-full flex justify-between p-2">
                    <h3 className="text-lg text-bold">Fuel Type</h3>
                    <label className="text-lg pr-10">{carData.Fueltype}</label>
                </div>
            </div>
        </div>
        ...
        <ul className="w-full">
            ...
            <li>
            Manufacture year: {carData.Productionyear}
            </li>
            <li>
            VIN:: {carData.VIN}
            </li>
            <li>
            LOT number: {carData.Lot}
            </li>
        </ul>
